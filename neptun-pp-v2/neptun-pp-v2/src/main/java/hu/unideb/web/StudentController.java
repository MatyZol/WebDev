...
public interface StudentController {
    ...
    @GetMapping(path="/api/student/download" , produces = "text/csv")
    String download();
    ...
    void deleteByNeptun(@NonNull @PathVariable String neptun);

    @PostMapping("/api/student")
    Student createOne(@NonNull @RequestBody Student student);

    @PutMapping("/api/student")
    Student updateOne(@NonNull @RequestBody Student student);

    @PutMapping("/api/student/create")
    Student createOneWithNeptun(@NonNull @RequestBody Student student);
